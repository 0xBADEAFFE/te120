...
// implementation from https://gist.github.com/jesperdj/1019354#file-vecmath_sse_impl-hpp
#ifdef POSIX
// Compute dot product and return it in all four components of an XMM register
__m128 sse_dot4_ps(__m128 a, __m128 b) {
#ifdef __SSE4_1__
...
// Compute dot product
float sse_dot1_ps(__m128 a, __m128 b) {
...
*/
		out1[0] = sse_dot1_ps(_mm_loadu_ps(in1), _mm_loadu_ps(in2[0])) + in2[0][3];
		out1[1] = sse_dot1_ps(_mm_loadu_ps(in1), _mm_loadu_ps(in2[1])) + in2[1][3];
		out1[2] = sse_dot1_ps(_mm_loadu_ps(in1), _mm_loadu_ps(in2[2])) + in2[2][3];
#else
	#error "Not Implemented"
#endif
}
...
*/
		out1[0] = sse_dot1_ps( _mm_loadu_ps(in1), _mm_loadu_ps(in2[0]) );
		out1[1] = sse_dot1_ps( _mm_loadu_ps(in1), _mm_loadu_ps(in2[1]) );
		out1[2] = sse_dot1_ps( _mm_loadu_ps(in1), _mm_loadu_ps(in2[2]) );
#else
	#error "Not Implemented"
#endif
}
